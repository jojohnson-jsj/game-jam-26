...
const HARDWARE_ITEMS = [
	{"key": "oven",          "label": "Oven",          "desc": "Unlock more ovens",          "base_price": 300, "price_step": 50,  "max": 4},
	{"key": "latte_machine", "label": "Latte Machine", "desc": "Unlock more latte machines", "base_price": 225, "price_step": 25,  "max": 4},
